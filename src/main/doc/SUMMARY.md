...
* [Landsat8](section1/landsat8.md)
    * [Getting data from USGS](section1/getdatausgs.md)
    * [Discovering data from Terradue](section1/discover.md)
...
* [Getting started](section3/started.md)
    * [Read Landsat 8 data](section3/read.md)
