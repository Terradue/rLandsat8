...
OLI and TIRS band data can be converted to TOA spectral radiance using the radiance rescaling factors provided in the metadata file: \\( { L }_{ \lambda } = { M }_{ \lambda } \\)

$${ L }_{ \lambda  }={ M }{ L }{ Q }{ cal }+{ A }{ L }$$

$${ L }_{ \lambda }={ M } { \lambda } { A } $$

\\({ L }_{ \lambda } = { M }_{ \lambda }\\)
